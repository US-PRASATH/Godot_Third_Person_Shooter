...
func add_item(player_name: String, score_value: String) -> void:
	...
	$"ScrollContainer/Board/HighScores/ScoreItemContainer".add_child(item)


func add_no_scores_message() -> void:
	var item = $"ScrollContainer/Board/MessageContainer/TextMessage"
	item.text = "No scores yet!"
	$"ScrollContainer/Board/MessageContainer".show()
	item.offset_top = 135
...
func hide_message() -> void:
	$"ScrollContainer/Board/MessageContainer".hide()


func clear_leaderboard() -> void:
	var score_item_container = $"ScrollContainer/Board/HighScores/ScoreItemContainer"
